...
namespace ChainSafe.GamingSDK.EVM.Tests
{
    ...
    public class ChainSafeRpcTests
    {
        ...
        {
            var contract = new Contract(_nftABi, _nftAddress, _infuraProvider);
        ...
        {
            var contract = new Contract(_nftABi, _goerliAddress, _infuraProvider);
        ...
        public void SendContractOverrideGasTest()
        {
            ...
            var contract = new Contract(_nftABi, _nftAddress, _ganacheProvider);
            var ret = contract.Attach(_nftAddress).Connect(signer).Send("mint", null, new TransactionRequest
            {
