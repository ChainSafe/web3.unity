...
using ChainSafe.Gaming.Evm.Contracts.Builders.FilterInput;
...
namespace ChainSafe.Gaming.Evm.Contracts.Extensions
{
    ...
    public static class EventExtensions
    {
        ...
        public static bool IsLogForEvent(this EventABI eventABI, FilterLog log)
        {
            ...
            if (!eventABI.HasSameNumberOfIndexes(log))
            {
                return false;
            }
        ...
        public static EventABI GetEventABI<TEventDTO>()
        ...
        public static EventABI GetEventABI<TEventDTO>(this TEventDTO eventDTO)
            where TEventDTO : IEventDTO
        {
            var eventABI = ABITypedRegistry.GetEvent<TEventDTO>();
            return eventABI;
        ...
        public static FilterInputBuilder<TEventDTO> GetFilterBuilder<TEventDTO>(this TEventDTO eventDTO)
        ...
        public static NewFilterInput CreateFilterInput(
        ...
        public static NewFilterInput CreateFilterInput<T1>(
            this EventABI eventABI,
            string contractAddress,
            T1 filterTopic1,
            BlockParameter fromBlock = null,
        ...
        public static NewFilterInput CreateFilterInput<T1, T2>(
            this EventABI eventABI,
            string contractAddress,
            T1 filterTopic1,
            T2 filterTopic2,
        ...
        public static NewFilterInput CreateFilterInput<T1, T2, T3>(
            this EventABI eventABI,
            string contractAddress,
            T1 filterTopic1,
            T2 filterTopic2,
        ...
        public static NewFilterInput CreateFilterInput<T1>(
            ...
            BlockParameter toBlock = null)
        {
            return eventABI.CreateFilterInput(filterOrTopics1.Cast<object>().ToArray(), fromBlock, toBlock);
        }
            ...
            BlockParameter toBlock = null)
        {
            return eventABI.CreateFilterInput(
                contractAddress,
                filterOrTopics1.Cast<object>().ToArray(),
                fromBlock,
                toBlock);
        }
        ...
        {
            return eventABI.CreateFilterInput(
                filterOrTopics1.Cast<object>().ToArray(), filterOrTopics2.Cast<object>().ToArray(), fromBlock, toBlock);
        }
            ...
            BlockParameter toBlock = null)
        {
            return eventABI.CreateFilterInput(
                contractAddress,
                filterOrTopics1.Cast<object>().ToArray(),
                filterOrTopics2.Cast<object>().ToArray(),
                fromBlock,
                toBlock);
        }
            ...
            BlockParameter toBlock = null)
        {
            return eventABI.CreateFilterInput(
                filterOrTopics1.Cast<object>().ToArray(),
                filterOrTopics2.Cast<object>().ToArray(),
                filterOrTopics3.Cast<object>().ToArray(),
                fromBlock,
                toBlock);
        }
        ...
        public static bool IsFilterInputForContractAddress(string contractAdress, NewFilterInput filterInput)
        {
            ...
            {
                return filterInput.Address.Count(x => x.IsTheSameAddress(contractAdress)) > 0;
            }
        ...
        public static List<EventLog<TEventDTO>> DecodeAllEvents<TEventDTO>(this JArray logs)
            where TEventDTO : new()
        {
            var eventABI = ABITypedRegistry.GetEvent<TEventDTO>();
        ...
        public static List<EventLog<TEventDTO>> DecodeAllEvents<TEventDTO>(this FilterLog[] logs)
            where TEventDTO : new()
        {
            var eventABI = ABITypedRegistry.GetEvent<TEventDTO>();
        ...
        public static List<EventLog<TEventDTO>> DecodeAllEvents<TEventDTO>(this EventABI eventABI, JArray logs)
            where TEventDTO : new()
        {
        ...
        public static List<EventLog<TEventDTO>> DecodeAllEvents<TEventDTO>(this EventABI eventABI, FilterLog[] logs)
            where TEventDTO : new()
        {
        ...
        public static EventLog<TEventDTO> DecodeEvent<TEventDTO>(this EventABI eventABI, FilterLog log)
            where TEventDTO : new()
        {
            if (!IsLogForEvent(eventABI, log))
            {
        ...
        public static EventLog<TEventDTO> DecodeEvent<TEventDTO>(this FilterLog log)
            where TEventDTO : new()
        {
            var eventABI = ABITypedRegistry.GetEvent<TEventDTO>();
        ...
        public static TEventDTO DecodeEvent<TEventDTO>(this TEventDTO eventDTO, JToken log)
            where TEventDTO : IEventDTO
        {
            var filterLog = JsonConvert.DeserializeObject<FilterLog>(log.ToString());
        ...
        public static TEventDTO DecodeEvent<TEventDTO>(this TEventDTO eventDTO, FilterLog log)
            where TEventDTO : IEventDTO
        {
            var eventABI = ABITypedRegistry.GetEvent<TEventDTO>();
        ...
        public static TEventDTO DecodeEvent<TEventDTO>(this TEventDTO eventDTO, EventABI eventABI, FilterLog log)
            where TEventDTO : IEventDTO
        {
            if (!IsLogForEvent(eventABI, log))
            {
        ...
        public static bool IsLogForEvent<TEventDTO>(this TEventDTO eventDTO, JToken log)
            where TEventDTO : IEventDTO
        {
            return IsLogForEvent<TEventDTO>(log);
        }

        public static bool IsLogForEvent<TEventDTO>(this TEventDTO eventDTO, FilterLog log)
            where TEventDTO : IEventDTO
        {
            return IsLogForEvent<TEventDTO>(log);
        }

        public static bool HasSameNumberOfIndexes<TEventDTO>(FilterLog log)
            where TEventDTO : IEventDTO
        {
            var eventABI = ABITypedRegistry.GetEvent<TEventDTO>();
        ...
        public static bool HasSameNumberOfIndexes<TEventDTO>(this TEventDTO eventDTO, FilterLog log)
            where TEventDTO : IEventDTO
        {
        ...
        public static List<EventLog<TEventDTO>> DecodeAllEventsIgnoringIndexMisMatches<TEventDTO>(this FilterLog[] logs)
