...
// Generated by Apple Swift version 5.9 (swiftlang-5.9.0.120.7 clang-1500.0.34.3)
...
SWIFT_EXTERN void setOnRampPurchase(void (* _Nonnull delegate)(double, char const * _Nullable, NSInteger, char const * _Nonnull, char const * _Nonnull, char const * _Nonnull, double, double, char const * _Nonnull, char const * _Nonnull, char const * _Nullable, char const * _Nullable, char const * _Nullable, char const * _Nonnull, double, char const * _Nullable, char const * _Nonnull, double, char const * _Nonnull, char const * _Nonnull, char const * _Nonnull, char const * _Nonnull));
