...
namespace ChainSafe.Gaming.Exchangers.Ramp.Sample
{
    public class RampSample : MonoBehaviour
    {
        ...
        private async void OnRampPressed()
        {
            ...
            var purchaseData = await ChainSafeManager.Web3.RampExchanger().BuyCrypto(
        ...
        private async void OffRampPressed()
        {
            ...
            var saleData = await ChainSafeManager.Web3.RampExchanger().SellCrypto(
        ...
        private async void OnRampOffRampPressed()
        {
            ...
            var rampTransactionData = await ChainSafeManager.Web3.RampExchanger().BuyOrSellCrypto(
