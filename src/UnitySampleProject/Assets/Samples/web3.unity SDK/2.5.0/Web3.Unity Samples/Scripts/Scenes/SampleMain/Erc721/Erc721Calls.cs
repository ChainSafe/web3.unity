...
public class Erc721Calls : MonoBehaviour
{
    ...
    string chainAllErc = "ethereum";
    string networkAllErc = "goerli"; // mainnet goerli
    string accountAllErc = "0xfaecAE4464591F8f2025ba8ACF58087953E613b1";
    string contractAllErc = "0x2c1867BC3026178A47a677513746DCc6822A137A";
    int takeAllErc = 500;
    int skipAllErc = 0;
