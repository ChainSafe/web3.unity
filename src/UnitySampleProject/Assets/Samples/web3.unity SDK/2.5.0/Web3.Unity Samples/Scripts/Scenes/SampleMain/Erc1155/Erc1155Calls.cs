...
public class Erc1155Calls : MonoBehaviour
{
    ...
    string contractBalanceOf = "0x2c1867bc3026178a47a677513746dcc6822a137a";
    string accountBalanceOf = "0xd25b827D92b0fd656A1c829933e9b0b836d5C3e2";
    string tokenIdBalanceOf = "0x01559ae4021aee70424836ca173b6a4e647287d15cee8ac42d8c2d8d128927e5";

    #endregion
    
    #region Balance Of Batch

    string contractBalanceOfBatch = "0xdc4aff511e1b94677142a43df90f948f9ae181dd";
    string[] accountsBalanceOfBatch = { "0xd25b827D92b0fd656A1c829933e9b0b836d5C3e2", "0xE51995Cdb3b1c109E0e6E67ab5aB31CDdBB83E4a" };
    ...
    string contractTransfer = "0xA0a53f1Cabf7D723Ab2087400681039917D1B6D4";
    int tokenIdTransfer = 1;
    int amountTransfer = 1;

    #endregion

    #region Texture

    string contractTexture = "0x0288B4F1389ED7b3d3f9C7B73d4408235c0CBbc6";
    string tokenIdTexture = "0";
