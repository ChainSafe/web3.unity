...
public class Erc1155Calls : MonoBehaviour
{
    ...
    public async void AllErc1155()
    {
        ...
        int take = 1000;
        int skip = 0;
        var allNfts = await erc1155.All(chain, network, account, contract, take, skip);
    ...
    {
        string contractAddress = "0x2c1867bc3026178a47a677513746dcc6822a137a";
        ...
        var balance = await erc1155.BalanceOf(contractAddress, account, tokenId);
    ...
    {
        string contractAddress = "0xdc4aff511e1b94677142a43df90f948f9ae181dd";
        string[] accounts = { "0xd25b827D92b0fd656A1c829933e9b0b836d5C3e2", "0xE51995Cdb3b1c109E0e6E67ab5aB31CDdBB83E4a" };
        string[] tokenIds = { "1", "2" };
        var balances = await erc1155.BalanceOfBatch(contractAddress, accounts, tokenIds);
    ...
    public async void MintErc1155()
    {
        ...
        string contractAddress = "0xA0a53f1Cabf7D723Ab2087400681039917D1B6D4";
        int id = 1;
        int amount = 1;
        var response = await erc1155.MintErc1155(abi, contractAddress, id, amount);
