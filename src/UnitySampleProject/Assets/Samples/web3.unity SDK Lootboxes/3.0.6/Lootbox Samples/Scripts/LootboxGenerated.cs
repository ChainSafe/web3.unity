...
namespace ChainSafe.Gaming.Evm.Contracts.Custom
{
    public partial class LootboxGenerated : ICustomContract
    {
        ...
        public async Task Initialize(string _uri, string _owner, TransactionRequest transactionOverwrite=null) 
        {
        ...
        public async Task<TransactionReceipt> InitializeWithReceipt(string _uri, string _owner, TransactionRequest transactionOverwrite=null) 
        {
        ...
        public async Task<byte[][]> Multicall(byte[][] data, TransactionRequest transactionOverwrite=null) 
        {
            var response = await OriginalContract.Send<byte[][]>("multicall", new object [] {
                data
            }, transactionOverwrite);
            
            return response;
        }
        public async Task<(byte[][] results, TransactionReceipt receipt)> MulticallWithReceipt(byte[][] data, TransactionRequest transactionOverwrite=null) 
        {
            var response = await OriginalContract.SendWithReceipt<byte[][]>("multicall", new object [] {
                data
            }, transactionOverwrite);
        ...
        public async Task<byte[]> OnERC1155BatchReceived(string param1, string from, BigInteger[] ids, BigInteger[] values, byte[] param2, TransactionRequest transactionOverwrite=null) 
        {
            var response = await OriginalContract.Send<byte[]>("onERC1155BatchReceived", new object [] {
                param1, from, ids, values, param2
            }, transactionOverwrite);
            
            return response;
        }
        public async Task<(byte[] , TransactionReceipt receipt)> OnERC1155BatchReceivedWithReceipt(string param1, string from, BigInteger[] ids, BigInteger[] values, byte[] param2, TransactionRequest transactionOverwrite=null) 
        {
        ...
        public async Task<byte[]> OnERC1155Received(string param1, string from, BigInteger id, BigInteger value, byte[] param2, TransactionRequest transactionOverwrite=null) 
        {
            var response = await OriginalContract.Send<byte[]>("onERC1155Received", new object [] {
                param1, from, id, value, param2
            }, transactionOverwrite);
            
            return response;
        }
        public async Task<(byte[] , TransactionReceipt receipt)> OnERC1155ReceivedWithReceipt(string param1, string from, BigInteger id, BigInteger value, byte[] param2, TransactionRequest transactionOverwrite=null) 
        {
        ...
        public async Task<byte[]> OnERC721Received(string param1, string from, BigInteger tokenId, byte[] param2, TransactionRequest transactionOverwrite=null) 
        {
            var response = await OriginalContract.Send<byte[]>("onERC721Received", new object [] {
                param1, from, tokenId, param2
            }, transactionOverwrite);
            
            return response;
        }
        public async Task<(byte[] , TransactionReceipt receipt)> OnERC721ReceivedWithReceipt(string param1, string from, BigInteger tokenId, byte[] param2, TransactionRequest transactionOverwrite=null) 
        {
        ...
        public async Task Open(BigInteger param1, BigInteger[] _lootIds, BigInteger[] _lootAmounts, TransactionRequest transactionOverwrite=null) 
        {
            var response = await OriginalContract.Send("open", new object [] {
                param1, _lootIds, _lootAmounts
            }, transactionOverwrite);
            
            
        }
        public async Task<TransactionReceipt> OpenWithReceipt(BigInteger param1, BigInteger[] _lootIds, BigInteger[] _lootAmounts, TransactionRequest transactionOverwrite=null) 
        {
        ...
        public async Task OpenFor(string _to, BigInteger[] _lootIds, BigInteger[] _lootAmounts, TransactionRequest transactionOverwrite=null) 
        {
            var response = await OriginalContract.Send("openFor", new object [] {
                _to, _lootIds, _lootAmounts
            }, transactionOverwrite);
            
            
        }
        public async Task<TransactionReceipt> OpenForWithReceipt(string _to, BigInteger[] _lootIds, BigInteger[] _lootAmounts, TransactionRequest transactionOverwrite=null) 
        {
            var response = await OriginalContract.SendWithReceipt("openFor", new object [] {
                _to, _lootIds, _lootAmounts
            }, transactionOverwrite);
