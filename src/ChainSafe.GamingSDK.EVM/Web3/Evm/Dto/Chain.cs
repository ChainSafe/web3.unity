...
namespace ChainSafe.GamingWeb3.Evm
{
  public class Chain
  {
    public class NativeCurrency
    {
      ...
      [JsonProperty(PropertyName = "decimals")] public ulong Decimals { get; set; }
    }
    ...
    [JsonProperty(PropertyName = "nativeCurrency")] public NativeCurrency NativeCurrencyInfo { get; set; }
    [JsonProperty(PropertyName = "infoURL")] public string InfoUrl { get; set; }
    [JsonProperty(PropertyName = "chainId")] public ulong ChainId { get; set; }
    [JsonProperty(PropertyName = "networkId")] public ulong NetworkId { get; set; }
    [JsonProperty(PropertyName = "ens")] public ENS Ens { get; set; }
    [JsonProperty(PropertyName = "explorers")] public Explorer[] Explorers { get; set; }
  }
}