...
rem Copy the old version that works with web3auth to the libraries folder
copy /Y "%SCRIPT_DIR%"\..\libs\Nethereum-UnityAOT\BouncyCastle.Crypto.dll "..\..\..\..\..\..\Packages\io.chainsafe.web3-unity\Runtime\Libraries"
