// This is a slightly modified version of https://github.com/endel/NativeWebSocket
    ...
    public sealed class WebSocket : IWebSocket
    {
            ...
            ArraySegment<byte> buffer)
        {
            ...
            try
            {
                ...
                if (!taken)
                {
                    ReownLogger.Log("[WebSocket] Could not obtain exclusive access to the socket.");
