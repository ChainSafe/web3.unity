...
namespace ChainSafe.Gaming.Evm.Contracts.Custom
{
    public class TestContract : ICustomContract
    {
        ...
        public async Task ListItems(string[] nftContracts, BigInteger[] tokenIds, BigInteger[] amounts, BigInteger[] prices, BigInteger[] deadlines) 
        {
        ...
        public async Task<TransactionReceipt> ListItemsWithReceipt(string[] nftContracts, BigInteger[] tokenIds, BigInteger[] amounts, BigInteger[] prices, BigInteger[] deadlines) 
        {
        ...
        public async Task<byte[]> OnERC1155BatchReceived(string @operator, string from, BigInteger[] ids, BigInteger[] values, byte[] data) 
        {
        ...
        public async Task<byte[]> OnERC1155Received(string @operator, string from, BigInteger id, BigInteger value, byte[] data) 
        {
