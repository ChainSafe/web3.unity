...
namespace Scripts.EVM.Marketplace
{
    public class Marketplace
    {
        ...
        {
            var path = $"/items?chainId={ChainSafeManager.Web3.ChainConfig.ChainId}";
        ...
        {
            var path = $"/tokens?chainId={ChainSafeManager.Web3.ChainConfig.ChainId}";
        ...
        public static async Task<TransactionReceipt> Create721Collection(string _bearerToken, string _name, string _description, bool _isMintingPublic)
        {
            ...
            var formData = new List<IMultipartFormSection>
                {
                    ...
                    new MultipartFormDataSection("owner", ChainSafeManager.Web3.Signer.PublicAddress),
                    new MultipartFormDataSection("chain_id", ChainSafeManager.Web3.ChainConfig.ChainId),
                    new MultipartFormDataSection("projectID", ChainSafeManager.Web3.ProjectConfig.ProjectId),
                    ...
                    new MultipartFormDataSection("contractAddress", ChainSafeContracts.MarketplaceContracts[ChainSafeManager.Web3.ChainConfig.ChainId]),
            ...
            object[] args =
            {
                    ChainSafeManager.Web3.ProjectConfig.ProjectId,
                    collectionData.id,
                    _name,
                    collectionData.type,
            ...
            var contract = ChainSafeManager.Web3.ContractBuilder.Build(ABI.MarketplaceFactory, ChainSafeContracts.MarketplaceContracts[ChainSafeManager.Web3.ChainConfig.ChainId]);
        ...
        public static async Task<TransactionReceipt> Mint721CollectionNft(string _bearerToken, string _collectionContract, string _name, [CanBeNull] string _description)
        {
            try
            {
                ...
                var contract = ChainSafeManager.Web3.ContractBuilder.Build(ABI.GeneralErc721, _collectionContract);
        ...
        public static async Task<TransactionReceipt> Mint1155CollectionNft(string _bearerToken, string _collectionContract, string _amount, string _name, [CanBeNull] string _description)
        {
            try
            {
                ...
                var contract = ChainSafeManager.Web3.ContractBuilder.Build(ABI.GeneralErc1155, _collectionContract);
                var txArgs = new TransactionRequest
                {
                    GasLimit = new HexBigInteger(90000)
                };
        ...
        public static async Task<TransactionReceipt> SetApprovalMarketplace(string _nftContract, string _marketplaceContract, string _type, bool _permission)
        {
            try
            {
                ...
                var contract = ChainSafeManager.Web3.ContractBuilder.Build(abi, _nftContract);
                var data = await contract.SendWithReceipt(method, args);
                return data.receipt;
            }
            catch (Web3Exception e)
        ...
        public static async Task<TransactionReceipt> PurchaseNft(string _marketplaceContract, string _itemId, string _amountToSend)
        {
            try
            {
                ...
                var contract = ChainSafeManager.Web3.ContractBuilder.Build(ABI.Marketplace, _marketplaceContract);
