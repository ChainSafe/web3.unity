...
public class Web3AuthWalletGUITxManager : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        _transactionHandler = ChainSafeManager.Web3.ServiceProvider.GetService<IWeb3AuthTransactionHandler>();
    }
    ...
    {
        Application.OpenURL($"{ChainSafeManager.Web3.ChainConfig.BlockExplorerUrl}/tx/{txHash}");
    }
