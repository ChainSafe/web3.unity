...
#ifndef RAMPCHAINSAFEINTEGRATION_SWIFT_H
#define RAMPCHAINSAFEINTEGRATION_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="RampChainsafeIntegration",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC24RampChainsafeIntegration11OffRampSale")
...
SWIFT_CLASS("_TtC24RampChainsafeIntegration20OfframpAssetInfoObjC")
...
SWIFT_CLASS("_TtC24RampChainsafeIntegration14OnRampPurchase")
...
SWIFT_CLASS("_TtCC24RampChainsafeIntegration14OnRampPurchase9AssetInfo")
...
SWIFT_EXTERN void OpenRamp(int32_t requestId, int32_t onRamp, int32_t offRamp, char const * _Nullable swapAsset, char const * _Nullable offrampAsset, int32_t swapAmount, char const * _Nullable fiatCurrency, int32_t fiatValue, char const * _Nullable userAddress, char const * _Nullable hostLogoUrl, char const * _Nullable hostAppName, char const * _Nullable userEmailAddress, char const * _Nullable selectedCountryCode, char const * _Nullable defaultAsset, char const * _Nullable url, char const * _Nullable webhookStatusUrl, char const * _Nullable hostApiKey, char const * _Nullable offrampWebHookV3Url, int32_t useSendCryptoCallback);


SWIFT_EXTERN void setOffRampSale(void (* _Nonnull delegate)(NSInteger, char const * _Nonnull, char const * _Nonnull, char const * _Nullable, char const * _Nonnull, NSInteger, char const * _Nonnull, char const * _Nonnull, char const * _Nonnull, double, char const * _Nonnull, NSUUID * _Nonnull));


SWIFT_EXTERN void setOnRampPurchase(void (* _Nonnull delegate)(NSInteger, double, char const * _Nullable, NSInteger, char const * _Nonnull, char const * _Nonnull, char const * _Nonnull, double, double, char const * _Nonnull, char const * _Nonnull, char const * _Nullable, char const * _Nullable, char const * _Nullable, char const * _Nonnull, double, char const * _Nullable, char const * _Nonnull, double, char const * _Nonnull, char const * _Nonnull, char const * _Nonnull, char const * _Nonnull));
