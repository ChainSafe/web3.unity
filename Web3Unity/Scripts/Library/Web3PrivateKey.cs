...
public class Web3PrivateKey
{
    ...
    public static string SignTransaction(string _privateKey, string _transaction, string _chainId)
    {
        ...
        if ((CHAIN_ID == MATIC_MAIN) || (CHAIN_ID == MATIC_MUMBAI) || (CHAIN_ID == HARMONY_MAINNET) ||
            (CHAIN_ID == HARMONY_TESTNET) || (CHAIN_ID == CRONOS_MAINNET) || (CHAIN_ID == CRONOS_TESTNET) || (CHAIN_ID == FTM_MAINNET) || (CHAIN_ID == FTM_TESTNET) || (CHAIN_ID == AVA_MAINNET) || (CHAIN_ID == AVA_TESTNET) || (CHAIN_ID == ARBITRUM_MAINNET) || (CHAIN_ID == ARBITRUM_TESTNET))
        {
