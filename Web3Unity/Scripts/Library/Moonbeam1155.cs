...
using Moonbeam1155Definition;
using UnityEngine;
using UnityEngine.Networking;

public class Moonbeam1155
{
    ...
    BalanceOf(string _network, string _contract, string _account, string _id)
    {
        string url =
            host +
            "/moonbeam1155/balanceOf?network=" +
            _network +
            "&contract=" +
            _contract +
            "&id=" +
    ...
    )
    {
        string url =
            host +
            "/moonbeam1155/balanceOfBatch?network=" +
            _network +
            "&contract=" +
            _contract +
            "&ids=" +
    ...
    )
    {
        string url =
            host +
            "/moonbeam1155/isApprovedForAll?network=" +
            _network +
            "&contract=" +
            _contract +
            "&account=" +
