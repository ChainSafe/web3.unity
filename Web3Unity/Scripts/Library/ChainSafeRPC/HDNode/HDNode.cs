...
//
//         private static readonly object _constructorGuard = new object();
//
...
//             return new Rfc2898DeriveBytes(pass, salt, 2048, HashAlgorithmName.SHA512).GetBytes(64);
//         }
//
...
//                 {
//                     indices[^1] <<= 8;
//                     indices[^1] |= e >> (8 - remainingBits);
//                     remainingBits -= 8;
//                 }
//                 else // This byte will complete an 11-bit index
//                 {
//                     indices[^1] <<= remainingBits;
//                     indices[^1] |= e >> (8 - remainingBits);
//
//                     // Start the next word
...
//             indices[^1] <<= checksumBits;
//             indices[^1] |= checksum >> (8 - checksumBits);
//
