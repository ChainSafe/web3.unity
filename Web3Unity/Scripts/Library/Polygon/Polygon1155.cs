...
using Polygon1155Definition;
using UnityEngine;
using UnityEngine.Networking;

public class Polygon1155
{
    ...
    )
    {
        string url =
            host +
            "/polygon1155/balanceOfBatch?network=" +
            _network +
            "&contract=" +
            _contract +
            "&ids=" +
    ...
    )
    {
        string url =
            host +
            "/polygon1155/isApprovedForAll?network=" +
            _network +
            "&contract=" +
            _contract +
            "&account=" +
