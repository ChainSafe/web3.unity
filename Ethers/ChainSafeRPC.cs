...
namespace Web3Unity.Scripts.Prefabs.Ethers
{
    public class ChainSafeRPC 
    {
        ...
        public static async Task<string> GetBalance(string _address)
        {
           ...
           Console.WriteLine($"Balance: {Units.FormatEther(balance)} ETH");
        ...
        public async Task<string> GetCode(string _address)
        {
            ...
            Console.WriteLine($"Contract code: {code}");
            return code;
        }
        ...
        public static async Task<string> GetLastBlock()
        {
            ...
            Console.WriteLine($"Last block hash: {latestBlock.BlockHash}");
            Console.WriteLine($"Last block parent hash: {latestBlock.ParentHash}");
            Console.WriteLine($"Last block number: {latestBlock.Number}");
            Console.WriteLine($"Last block timestamp: {latestBlock.Timestamp}");
            Console.WriteLine($"Last block nonce: {latestBlock.Nonce}");
            Console.WriteLine($"Last block gas limit: {latestBlock.GasLimit}");
            Console.WriteLine($"Last block gas used: {latestBlock.GasUsed}");
        ...
        public static async Task<string> GetPreviousBlock()
        {
            ...
            Console.WriteLine(block15M != null
        ...
        public static async Task<string> GetTransactionCount(string _address)
        {
            ...
            Console.WriteLine($"Transaction count: {txCount}");
        ...
        public static async Task<string> GetFeeData()
        {
            ...
            Console.WriteLine($"GasPrice: {Units.FormatUnits(feeData.GasPrice, "gwei")} gwei");
            Console.WriteLine($"MaxFeePerGas: {Units.FormatUnits(feeData.MaxFeePerGas, "gwei")} gwei");
            Console.WriteLine($"MaxPriorityFeePerGas: {Units.FormatUnits(feeData.MaxPriorityFeePerGas, "gwei")} gwei");
        ...
        public static async Task<string> GetGasPrice()
        {
            ...
            Console.WriteLine($"GasPrice: {gasPrice} wei");
            var gwei = Units.FormatUnits(gasPrice, "gwei");
            Console.WriteLine($"GasPrice: {gwei} gwei");
        ...
        public static async Task<string> GetTransactionReceipt()
        {
            ...
            Console.WriteLine($"Block hash from TX {latestBlockWithTx.Transactions[0].Hash} receipt: {receipt.BlockHash}");
