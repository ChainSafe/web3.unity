...
namespace Tests
{
    ...
    public class ChainSafeRpcTests
    {
        ...
        {
            var balance = _provider.GetBalance(_goerliAddress).Result;
        ...
        {
            var code = _provider.GetCode(_goerliAddress).Result;
        ...
        {
            var txCount = _provider.GetTransactionCount(_goerliAddress).Result;
        ...
        public void EstimateGasContractMethodTest()
        {
            ...
            var contract = new Contract(abi, _goerliAddress, _provider);
